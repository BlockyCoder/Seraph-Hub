...
function Library:Create(xHubName)
	...
	function Library:SaveConfig(name, data)
		local success, err = pcall(function()
			...
			if not isfolder("UI_Library_Configs") then
				makefolder("UI_Library_Configs")
			end
			writefile("UI_Library_Configs/"..name..".json", json)
		end)
		return success, err
	end
	...
	function Library:LoadConfig(name)
		local success, err = pcall(function()
			if not isfolder("UI_Library_Configs") then return nil end
			local path = "UI_Library_Configs/"..name..".json"
